...
=== combatRequest 机制 ===
如果上下文中有 [战斗请求]，说明玩家明确表达了攻击意图。
- urgency='required'：除非目标无法战斗（友方/平民/幻影/远景/已死），否则必须返回 combatStart。
- urgency='preferred'：建议返回 combatStart。
如果无法战斗，在 scene.text 中说明原因，不要强行生成敌人。
